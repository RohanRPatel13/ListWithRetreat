...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        Node node = new Node(); // node to be added.
        node.data = x; // carrying the data.

        // link the new node with the right first.

        node.next = this.lastLeft.next;
        this.lastLeft.next.previous = node;

        // link the new node with the left last.
    ...
    public final T removeRightFront() {
        ...
        Node out = this.lastLeft.next; // node to be removed.

        // link out.next with left last.

        this.lastLeft.next = out.next;
        out.next.previous = this.lastLeft;
    ...
    public final void retreat() {
        ...
        // point last left to its previous.
