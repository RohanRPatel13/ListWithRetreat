...
public abstract class ListTest {
    ...
    /**
     * Helper method that tests the layering method {@code retreat}.
     *
     * @param leftLength
     *            length of left list originally.
     * @param elements
     *            elements in the list.
     */
    private void testRetreat(int leftLength, String... elements) {
        /*
         * Set up variables
         */
        List<String> test = this.createFromArgsTest(leftLength, elements);
        List<String> ref = this.createFromArgsRef(leftLength, elements);
        /*
         * Call method under test
         */
        test.retreat();
    ...
    public void testRetreatLeftOneRightEmpty() {
        this.testRetreat(1, "red");
    }

    @Test
    public final void testRetreatLeftNonEmptyRightEmpty() {
        this.testRetreat(3, "green", "red", "blue");
    }

    @Test
    public final void testRetreatLeftOneRightNoEmpty() {
        this.testRetreat(1, "yellow", "orange", "purple", "red");
    }

    @Test
    public final void testRetreatLeftNonEmptyRightNonEmpty() {
        this.testRetreat(2, "yellow", "orange", "green", "purple");
    }
